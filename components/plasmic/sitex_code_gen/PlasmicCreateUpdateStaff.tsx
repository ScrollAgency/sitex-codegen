...
import sty from "./PlasmicCreateUpdateStaff.module.css"; // plasmic-import: qFrCbEPqodnx/css
...
export type PlasmicCreateUpdateStaff__VariantMembers = {};
export type PlasmicCreateUpdateStaff__VariantsArgs = {};
type VariantPropType = keyof PlasmicCreateUpdateStaff__VariantsArgs;
export const PlasmicCreateUpdateStaff__VariantProps =
  new Array<VariantPropType>();

export type PlasmicCreateUpdateStaff__ArgsType = {
  open?: boolean;
...
type ArgPropType = keyof PlasmicCreateUpdateStaff__ArgsType;
export const PlasmicCreateUpdateStaff__ArgProps = new Array<ArgPropType>(
  "open",
  "onOpenChange",
  "staffId",
  "onStaffIdChange",
...
export type PlasmicCreateUpdateStaff__OverridesType = {
...
export interface DefaultCreateUpdateStaffProps {
  open?: boolean;
  onOpenChange?: (val: string) => void;
  staffId?: any;
  onStaffIdChange?: (val: string) => void;
...
function PlasmicCreateUpdateStaff__RenderFunc(props: {
  variants: PlasmicCreateUpdateStaff__VariantsArgs;
  args: PlasmicCreateUpdateStaff__ArgsType;
  overrides: PlasmicCreateUpdateStaff__OverridesType;
  forNode?: string;
}) {
    ...
    () => [
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) =>
          (() => {
            try {
              return $state.form.value.fixed_price;
            } catch (e) {
              if (
                e instanceof TypeError ||
                e?.plasmicType === "PlasmicUndefinedDataError"
  ...
  return (
    <Modal
        ...
        <React.Fragment>
          {(() => {
            const child$Props = {
              ...
              initialValues: (() => {
                try {
                  return $state.mode === "update" ? $state.staffId : null;
                } catch (e) {
                  if (
                    e instanceof TypeError ||
                    e?.plasmicType === "PlasmicUndefinedDataError"
                  ...
                  $state.mode === "update"
                    ? (() => {
                        const actionArgs = {
                          dataOp: {
                            sourceId: "v6umJuHyep6kPNyCAJjouT",
                            opId: "4365f07d-a294-4602-bca3-64594c80f6ad",
                            userArgs: {
                              keys: [$state.staffId.id],
                              variables: [
                                {
                                  ...Object.fromEntries(
                                    Object.entries($state.form.value).filter(
                                      ([key, value]) => key !== "id"
                                    )
                                  ),
                                  last_updated_by:
            ...
            return (
              ...
              >
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__zqAd6)}
                  label={
                    <div
                ...
                >
                  <AntdSelect
                    ...
                    placeholderClassName={classNames({
                      [sty["pcls_dwCMWA4jCBwd"]]: true
                    })}
                    popupClassName={classNames({
                      [sty["pcls_xFG1Rmnx7H5b"]]: true
                    })}
                    popupScopeClassName={sty["select2__popup"]}
                    size={"middle"}
                    triggerClassName={classNames({
                      [sty["pcls_PFmnpqpmWEjc"]]: true
                    })}
                    value={generateStateValueProp($state, ["select2", "value"])}
                  />
                </FormItemWrapper>
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__rmsPa)}
                ...
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__bzy3)}
                  initialValue={undefined}
                  label={
                    <div
                      className={classNames(
                ...
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__p4Nz)}
                  initialValue={
                    $state.mode === "create"
                      ? false
                      : $state.staffId.fixed_price
                  }
                  label={
                    <div
                      className={classNames(
                    ...
                    rules={[
                      {
                        ...
                        custom: (rule, value) => {
                          return $state.form.value.fixed_price &&
                            !$state.form.value.fixed_price_amount
                            ? false
                            : true;
                        },
                        message: "Requis"
                ...
                {(() => {
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__ncrSy)}
                  >
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox___6Xhi)}
                    >
                      <FormItemWrapper
                        className={classNames(
                          "__wab_instance",
                          sty.formField__idC3E
                        )}
                        initialValue={undefined}
                        label={
                          <div
                        ...
                        rules={[
                          {
                            ...
                            custom: (rule, value) => {
                              return !$state.form.value.fixed_price &&
                                !$state.form.value.unit_price_day
                                ? false
                                : true;
                            },
                            message: "Requis"
                      ...
                      <FormItemWrapper
                        ...
                        label={
                          ...
                          >
                            {"Prix unitaire HT (nuit)"}
                          </div>
                        }
                        name={"unit_price_night"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__kUkrE)}
                    >
                      <FormItemWrapper
                        className={classNames(
                          "__wab_instance",
                          sty.formField__jkpZj
                        )}
                        initialValue={undefined}
                        label={
                          <div
                          ...
                          >
                            {"Prix unitaire HT dimanche (jour)"}
                          </div>
                        }
                        name={"unit_price_sun_day"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                      ...
                      <FormItemWrapper
                        ...
                        label={
                          ...
                          >
                            {"Prix unitaire HT dimanche (nuit)"}
                          </div>
                        }
                        name={"unit_price_sun_night"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__mw16Q)}
                    >
                      <FormItemWrapper
                        className={classNames(
                          "__wab_instance",
                          sty.formField__u6OqQ
                        )}
                        initialValue={undefined}
                        label={
                          <div
                          ...
                          >
                            {"Prix unitaire HT f\u00e9ri\u00e9 (jour)"}
                          </div>
                        }
                        name={"unit_price_holiday_day"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                      ...
                      <FormItemWrapper
                        ...
                        label={
                          ...
                          >
                            {"Prix unitaire HT f\u00e9ri\u00e9 (nuit)"}
                          </div>
                        }
                        name={"unit_price_holiday_night"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                    ...
                    >
                      <FormItemWrapper
                        ...
                        label={
                          ...
                          >
                            {"Prix unitaire HT f\u00e9ri\u00e9 dimanche (jour)"}
                          </div>
                        }
                        name={"unit_price_sun_holiday_day"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                      ...
                      <FormItemWrapper
                        ...
                        label={
                          ...
                          >
                            {"Prix unitaire HT f\u00e9ri\u00e9 dimanche (nuit)"}
                          </div>
                        }
                        name={"unit_price_sun_holiday_night"}
                      >
                        {(() => {
                          const child$Props = {
                            className: classNames(
                ...
                <FormItemWrapper
                  className={classNames("__wab_instance", sty.formField__lXKaJ)}
                  initialValue={undefined}
                  label={
                    <div
                      className={classNames(
                ...
                >
                  <AntdSelect
                    ...
                    placeholderClassName={classNames({
                      [sty["pcls_iwGsynoui7Wc"]]: true
                    })}
                    popupClassName={classNames({
                      [sty["pcls_TLSvYsfdQsZ-"]]: true
                    })}
                    popupScopeClassName={sty["select__popup"]}
                    size={"middle"}
                    triggerClassName={classNames({
                      [sty["pcls_M5C1oqGar5pH"]]: true
                    })}
                    value={generateStateValueProp($state, ["select", "value"])}
                  />
                </FormItemWrapper>
                <Button
                  className={classNames("__wab_instance", sty.button__zGr7J)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
          ...
          >
            ...
            <SitexTextInput
              ...
              inputClassName={classNames({ [sty["pcls_UZIH8vMJu4ZH"]]: true })}
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <IcRoundPlusIcon
                        className={classNames(projectcss.all, sty.svg___2As2X)}
                        role={"img"}
                      />
            ...
            >
              ...
              {false ? (
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__qYd58)}
                  >
                    <Line9Icon
                      className={classNames(projectcss.all, sty.svg__ww48)}
                      role={"img"}
                    />
                  </div>
                  <div
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__jWKv)}
                  >
                    <Line9Icon
                      className={classNames(projectcss.all, sty.svg___8UBqF)}
                      role={"img"}
                    />
                  </div>
                </Stack__>
              ...
              {false ? (
                ...
                >
                  ...
                  >
                    <IcTwotoneAppleIcon
                      className={classNames(projectcss.all, sty.svg___1TZl)}
                      role={"img"}
                    />
                  ...
                  >
                    <MdiFacebookIcon
                      className={classNames(projectcss.all, sty.svg__oopEe)}
                      role={"img"}
                    />
      ...
      footer={<div className={classNames(projectcss.all, sty.freeBox__vFTj)} />}
      heading={
        <div
        ...
        >
          ...
          >
            <LinkSimpleIcon
              className={classNames(projectcss.all, sty.svg__m6Pnj)}
              role={"img"}
            />

            <XIcon
              className={classNames(projectcss.all, sty.svg___9WoVo)}
              onClick={async event => {
                const $steps = {};
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCreateUpdateStaff__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCreateUpdateStaff__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicCreateUpdateStaff__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCreateUpdateStaff__ArgProps,
          internalVariantPropNames: PlasmicCreateUpdateStaff__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCreateUpdateStaff__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "crateStaff") {
    func.displayName = "PlasmicCreateUpdateStaff";
  } else {
    func.displayName = `PlasmicCreateUpdateStaff.${nodeName}`;
  }
  return func;
}

export const PlasmicCreateUpdateStaff = Object.assign(
  // Top-level PlasmicCreateUpdateStaff renders the root element
  makeNodeComponent("crateStaff"),
  {
    ...
    // Metadata about props expected for PlasmicCreateUpdateStaff
    internalVariantProps: PlasmicCreateUpdateStaff__VariantProps,
    internalArgProps: PlasmicCreateUpdateStaff__ArgProps
  }
);

export default PlasmicCreateUpdateStaff;
/* prettier-ignore-end */
