...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 8tg49zFadB9H/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pyCO)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__hrivy)}>
            <div
              className={classNames(
                projectcss.all,
