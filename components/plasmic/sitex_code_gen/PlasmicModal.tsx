...
import sty from "./PlasmicModal.module.css"; // plasmic-import: 2dhqWpUZxzEb/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_KaB55EbaZkF-"]]: true })}
        ...
        >
          ...
          >
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__bqFJd)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__bqCez)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
