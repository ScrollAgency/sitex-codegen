...
import SliderThumb from "../../SliderThumb"; // plasmic-import: nnrdkCEc-MA-/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: POZSdLevlGmy/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__fBfbO)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__raMpx)}>
        <div
