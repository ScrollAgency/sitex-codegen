...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: QA-Gc8H2apHJ/css

import Check2Icon from "./icons/PlasmicIcon__Check2"; // plasmic-import: XxL1L1ANBbNT/icon
    ...
    >
      ...
      >
        {(
          ...
          <Check2Icon
            className={classNames(projectcss.all, sty.svg__jgWaM)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__aVd6X)}
            role={"img"}
          />
        ) : null}
      </div>
