...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: fzfVKlUA83rn/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__ibVP)}>
        <div className={classNames(projectcss.all, sty.freeBox__vIqmP)} />
      </div>
      {renderPlasmicSlot({
