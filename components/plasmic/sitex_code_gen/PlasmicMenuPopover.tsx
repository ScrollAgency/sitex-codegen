...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: AWrql9xy52fI/css
              ...
              defaultContents: (
                <React.Fragment>
                  <MenuItem
                    className={classNames(
                      "__wab_instance",
                      sty.menuItem___7I1Jh
                    )}
                    value={"item1"}
                  />

                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__ba3Y)}
                    label={"Item 2"}
                    value={"item2"}
                  />
