...
import sty from "./PlasmicButtonBottomMenu.module.css"; // plasmic-import: JyCXAdKcNiAC/css
...
export type PlasmicButtonBottomMenu__VariantMembers = {
...
export type PlasmicButtonBottomMenu__VariantsArgs = {
...
type VariantPropType = keyof PlasmicButtonBottomMenu__VariantsArgs;
export const PlasmicButtonBottomMenu__VariantProps = new Array<VariantPropType>(
  "color",
  "type",
  "size",
  "iconStart",
...
export type PlasmicButtonBottomMenu__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicButtonBottomMenu__ArgsType;
export const PlasmicButtonBottomMenu__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicButtonBottomMenu__OverridesType = {
...
export interface DefaultButtonBottomMenuProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicButtonBottomMenu__RenderFunc(props: {
  variants: PlasmicButtonBottomMenu__VariantsArgs;
  args: PlasmicButtonBottomMenu__ArgsType;
  overrides: PlasmicButtonBottomMenu__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__qp7K, {
            [sty.freeBoxcolor_neutral__qp7KcY7BS]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__qp7K47ESc]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__qp7Kh8Ce0]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__qp7KPl4Ar]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__qp7K6HGmm]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__qp7KDa7SM]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__qp7KAbMgCY7BS]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__d0AFx)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__lRyGb, {
            [sty.freeBoxiconEnd__lRyGbP0Hob]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__lRyGbh8Ce0]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__lRyGbPl4Ar]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__lRyGb6HGmm]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__u3OZ2)}
                role={"img"}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButtonBottomMenu__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButtonBottomMenu__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicButtonBottomMenu__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicButtonBottomMenu__ArgProps,
          internalVariantPropNames: PlasmicButtonBottomMenu__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicButtonBottomMenu__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonBottomMenu";
  } else {
    func.displayName = `PlasmicButtonBottomMenu.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonBottomMenu = Object.assign(
  // Top-level PlasmicButtonBottomMenu renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonBottomMenu
    internalVariantProps: PlasmicButtonBottomMenu__VariantProps,
    internalArgProps: PlasmicButtonBottomMenu__ArgProps
  }
);

export default PlasmicButtonBottomMenu;
/* prettier-ignore-end */
