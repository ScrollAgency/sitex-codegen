...
import sty from "./PlasmicButtonLeftMenuSauv.module.css"; // plasmic-import: 34kdC-03x8MN/css
...
export type PlasmicButtonLeftMenuSauv__VariantMembers = {
  color: "neutral" | "muted" | "success" | "warning" | "errorDestructive";
  type: "soft" | "bordered" | "current";
...
export type PlasmicButtonLeftMenuSauv__VariantsArgs = {
  color?: SingleChoiceArg<
    "neutral" | "muted" | "success" | "warning" | "errorDestructive"
  >;
  type?: SingleChoiceArg<"soft" | "bordered" | "current">;
...
type VariantPropType = keyof PlasmicButtonLeftMenuSauv__VariantsArgs;
export const PlasmicButtonLeftMenuSauv__VariantProps =
...
export type PlasmicButtonLeftMenuSauv__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicButtonLeftMenuSauv__ArgsType;
export const PlasmicButtonLeftMenuSauv__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicButtonLeftMenuSauv__OverridesType = {
...
export interface DefaultButtonLeftMenuSauvProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicButtonLeftMenuSauv__RenderFunc(props: {
  variants: PlasmicButtonLeftMenuSauv__VariantsArgs;
  args: PlasmicButtonLeftMenuSauv__ArgsType;
  overrides: PlasmicButtonLeftMenuSauv__OverridesType;
  forNode?: string;
}) {
      ...
      Object.assign(
        {
          onClick: (() => {
            try {
              return $state.subMenu3.selectedSubMenu;
            } catch (e) {
              if (
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.roottype_bordered_color_warning]:
            ...
            hasVariant($state, "type", "bordered"),
          [sty.roottype_current]: hasVariant($state, "type", "current"),
    ...
    >
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.interactionEffect, {
          ...
          [sty.interactionEffecttype_bordered_color_success]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.interactionEffecttype_current]: hasVariant(
            $state,
            "type",
            "current"
          ),
      ...
      <Stack__
        ...
        className={classNames(projectcss.all, projectcss.button, sty.button, {
          ...
          [sty.buttontype_bordered_color_success]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.buttontype_current]: hasVariant($state, "type", "current")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__eoAee, {
            [sty.freeBoxcolor_neutral__eoAeenuQd5]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__eoAee25T3V]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__eoAeeB7BjE]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__eoAee7U1B]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__eoAee9NAtR]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__eoAeeEixh6]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__eoAeecOyVNuQd5]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hKEr)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetStart, {
              ...
              [sty.slotTargetStarttype_bordered_color_warning]:
                hasVariant($state, "color", "warning") &&
                hasVariant($state, "type", "bordered"),
              [sty.slotTargetStarttype_current]: hasVariant(
                $state,
                "type",
                "current"
              ),
        ...
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetLabel, {
            ...
            [sty.slotTargetLabeltype_bordered_color_warning]:
              hasVariant($state, "color", "warning") &&
              hasVariant($state, "type", "bordered"),
            [sty.slotTargetLabeltype_current]: hasVariant(
              $state,
              "type",
              "current"
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___43LjR, {
            [sty.freeBoxiconEnd___43LjRjfVSo]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___43LjRb7BjE]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___43LjR7U1B]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___43LjR9NAtR]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__jFjYt)}
                role={"img"}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicButtonLeftMenuSauv__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicButtonLeftMenuSauv__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicButtonLeftMenuSauv__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicButtonLeftMenuSauv__ArgProps,
          internalVariantPropNames: PlasmicButtonLeftMenuSauv__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicButtonLeftMenuSauv__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicButtonLeftMenuSauv";
  } else {
    func.displayName = `PlasmicButtonLeftMenuSauv.${nodeName}`;
  }
  return func;
}

export const PlasmicButtonLeftMenuSauv = Object.assign(
  // Top-level PlasmicButtonLeftMenuSauv renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicButtonLeftMenuSauv
    internalVariantProps: PlasmicButtonLeftMenuSauv__VariantProps,
    internalArgProps: PlasmicButtonLeftMenuSauv__ArgProps
  }
);

export default PlasmicButtonLeftMenuSauv;
/* prettier-ignore-end */
